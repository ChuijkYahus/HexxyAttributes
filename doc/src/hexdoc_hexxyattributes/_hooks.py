...
import hexdoc_hexxyattributes

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexxyAttributesModPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexxyAttributesModModPlugin(branch=branch)


class HexxyAttributesModModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexxyattributes"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexxyattributes, "_templates"
