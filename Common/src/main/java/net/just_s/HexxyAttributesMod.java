...
public class HexxyAttributesMod {
    ...
    public static final DeferredRegister<EntityAttribute> ATTRIBUTES = DeferredRegister.create(MOD_ID, (RegistryKey<Registry<EntityAttribute>>) Registries.ATTRIBUTE.getKey());
