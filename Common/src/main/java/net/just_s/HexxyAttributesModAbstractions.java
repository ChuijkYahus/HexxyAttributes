...
public class HexxyAttributesModAbstractions {
     ...
     * Example:
     * <p>
     * Expect: net.just_s.HexxyAttributesModAbstractions#getConfigDirectory()
     * <p>
     * Actual Fabric: net.just_s.fabric.HexxyAttributesModAbstractionsImpl#getConfigDirectory()
     * <p>
     * Actual Forge: net.just_s.forge.HexxyAttributesModAbstractionsImpl#getConfigDirectory()
     * <p>
